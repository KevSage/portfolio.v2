        ...
        <ProjectList>
          <Project>
            <Main>
              ...
              <Description>
                <p>
                  Tongue.io was my capstone project at Flatiron. It is a
                  Language phrasebook and language translation program built on
                  a Rails Backend and React.js frontend with redux for state
                  management.
                </p>
                <p>
                  {" "}
                  Ruby on Rails | React.js | Redux | Material UI | JWToken |
                  OAuth | Google Translate API
                </p>
              </Description>
              <Left>
          ...
          <Project>
            <Main>
              ...
              <Description>
                <p>
                  This is a simple coronavirus tracker that keeps up with new
                  coronavirus infections worldwide. New cases, recoveries and
                  deaths are documented along with a bar graph showing
                  coronavirus spread over time.
                </p>
                <p>
                  {" "}
                  React.js | Open Disease DB API | React Leaflet Maps | React
                  ChartJS
                </p>
              </Description>
              <Left>
          ...
          <Project>
            <Main>
              ...
              <Description>
                <p>
                  Festival & Artist Database where users can follow their
                  favorite artists and festivals. Built on a Rails database and
                  Vanilla Javascript.
                </p>
                <p>
                  {" "}
                  Ruby on Rails | Semantic UI | JavaScript |JWToken | OAuth{" "}
                </p>
              </Description>
              <Left>
        ...
        <ProjectList>
          <Project>
            <Main>
              ...
              <Description>
                <p>
                  Classic Memory Game. Match the web technologies in record
                  time.
                </p>
          ...
          <Project>
            <Main>
              ...
              <Description>
                <p>
                  {" "}
                  Create your very own work of art by building a custom grid and
                  filling in the pixels with your design. Don't forget to print
                  your masterpiece when finished.
                </p>
        ...
        <ProjectList>
          ...
          <Project>
            <Main>
              ...
              <Description>
                <p>
                  Techniq is a landing page for a technology site based on
                  Engadget{" "}
                </p>
                <p> HTML| CSS | JavaScript | Bootstrap </p>
              </Description>
